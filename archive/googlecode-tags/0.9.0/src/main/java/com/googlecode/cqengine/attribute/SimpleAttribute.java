...
/**
 * Represents an attribute in an object (such as a field), and provides a method to read the value of the field
...
public abstract class SimpleAttribute<O, A> extends AbstractAttribute<O, A> {
    ...
    /**
     * Returns the value of the attribute from the object.
     * <p/>
