...
public class RegularMapTest {
    ...
    private static final Attribute<Map, Car.Color> COLOR_ATTR = mapAttribute("COLOR",Car.Color.class);
    private static final Attribute<Map, String> MANUFACTURER_ATTR = mapAttribute("MANUFACTURER", String.class);
    private static final Attribute<Map, Double> PRICE_ATTR = mapAttribute("PRICE", Double.class);
