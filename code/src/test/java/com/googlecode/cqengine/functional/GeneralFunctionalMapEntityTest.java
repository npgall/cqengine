...
import static com.googlecode.cqengine.query.QueryFactory.mapEntityAttribute;
 ...
 */
public class GeneralFunctionalMapEntityTest {

    private static final Attribute<MapEntity, String> MODEL_ATTR = mapEntityAttribute("MODEL", String.class);
    private static final Attribute<MapEntity, Integer> DOORS_ATTR = mapEntityAttribute("DOORS", Integer.class);
    private static final Attribute<MapEntity, Car.Color> COLOR_ATTR = mapEntityAttribute("COLOR",Car.Color.class);
    private static final Attribute<MapEntity, String> MANUFACTURER_ATTR = mapEntityAttribute("MANUFACTURER", String.class);
    private static final Attribute<MapEntity, Double> PRICE_ATTR = mapEntityAttribute("PRICE", Double.class);
    private static final Attribute<MapEntity, Integer> CAR_ID_ATTR = mapEntityAttribute("CAR_ID", Integer.class);

    @Test
    public void testGeneralFunctionality() {
        IndexedCollection<MapEntity> cars = new ConcurrentIndexedCollection<MapEntity>();
    ...
    static Set<Integer> carIdsIn(ResultSet<MapEntity> resultSet) {
        return valuesOf(CAR_ID_ATTR, resultSet);
    }

    MapEntity buildNewCar(int carId, String manufacturer, String model, Car.Color color, int doors, double price, List<String> features) {
        Map map = new HashMap();
